...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/superior-landing-page">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/superior-landing-page/styles.bundle.css`
      * `scripts`: `news/projects/all/superior-landing-page/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/superior-landing-page/",
      "url": "http://static.startribune.com/news/projects-staging/all/superior-landing-page/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/superior-landing-page/",
      "url": "http://static.startribune.com/news/projects/all/superior-landing-page/"
    }
  }
}
```
